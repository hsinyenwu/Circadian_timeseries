...
1. **Dataset1**: RNA-seq of circadian timeseries sampling (LL2-3) of 13-14 day old Arabidopsis thaliana Col-0 (24 h to 68 h, sampled every 4 h). Grown under LD 12h:12h. 2 biological replicates
